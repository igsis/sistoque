...
@section('content')	
    ...
    <div class="box box-primary">
        ...
        <form role="form" id="formRep" method="post" action="{{ route('pessoaJuridica.vincularRepresentante2') }}">
            {{ csrf_field() }}
            <div class="box-body">
            ...
            <div class="box-footer">
                ...
                <a class="btn btn-info" href="{{ route('pessoaJuridica.formRepresentante2') }}"> Pesquisar Outro </a>
            </div>
        </form>
