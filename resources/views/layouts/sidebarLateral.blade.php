...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="{{route('pedido')}}"><i class="glyphicon glyphicon-plus"></i> Solicitar Pedidio</a></li>
            <li><a href=""> <i class="glyphicon glyphicon-list-alt"></i>Em espera</a></li>
            <li><a href=""><i class="glyphicon glyphicon-ok"></i>Aprovados</a></li>
